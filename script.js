...
(() => {
  ...
  const ANTENNA_COLORS = {
    "Alpes Centre-Est": "rgba(217,199,255,0.28)", // lavande claire
    "Atlantique Grand-Ouest": "rgba(207,233,255,0.28)", // bleu-gris très clair (différent du pin bleu)
    "Grand Sud-Ouest": "rgba(255,211,191,0.28)", // pêche claire
    "Méditerranée Grand-Sud": "rgba(255,230,168,0.26)", // sable / beige (différent du pin jaune)
    "Nord-Est": "rgba(233,216,197,0.28)", // lin / taupe clair
    "Nord-Ouest Île-de-France": "rgba(247,199,230,0.28)" // rose poudré
  };
