...
(() => {
  ...
  const ANTENNA_COLORS = {
    "Atlantique Grand-Ouest": "#CFE9FF",
    "Nord-Est": "#E9D8C5",
    "Grand Sud-Ouest": "#FFD3BF",
    "Alpes Centre-Est": "#D9C7FF",
    "Méditerranée Grand-Sud": "#FFE6A8",
    "Nord-Ouest Île-de-France": "#F7C7E6"
};
...
marker.on("click", (e) => {
  ...
  function styleDept(feature) {
    ...
    const fillOpacity = isDeptSelected ? 0.85 : (isAntennaFocused ? 0.60 : (antenna ? 0.28 : 0.08));
