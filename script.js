...
// ---- Antennes / Couleurs ----
  ...
  const OFFICES = [
    {
      type_lieu: "antenne",
      nom: "Alpes Centre-Est",
      antenne: "Alpes Centre-Est",
      adresse: "10 rue Stella, 69002 Lyon",
      latitude: 45.76061,
      longitude: 4.83664
    },
    {
      type_lieu: "antenne",
      nom: "Nord-Ouest Île-de-France",
      antenne: "Nord-Ouest Île-de-France",
      adresse: "10 rue du Centre, 93196 Noisy-le-Grand Cedex",
      latitude: 48.838387,
      longitude: 2.545001
    },
    {
      type_lieu: "antenne",
      nom: "Méditerranée Grand-Sud",
      antenne: "Méditerranée Grand-Sud",
      adresse: "52 rue Liandier, 13008 Marseille",
      latitude: 43.2780891,
      longitude: 5.3913314
    },
    {
      ...
      nom: "Nord-Est",
      antenne: "Nord-Est",
      adresse: "14 rue du Maréchal Juin, 67000 Strasbourg",
      latitude: 48.577957,
      longitude: 7.762085
    },
    {
      type_lieu: "antenne",
      nom: "Grand Sud-Ouest",
      antenne: "Grand Sud-Ouest",
      adresse: "1 Place Émile Blouin, 31952 Toulouse",
      latitude: 43.61456,
      longitude: 1.466043
    },
    {
      type_lieu: "antenne",
      nom: "Atlantique Grand-Ouest",
      antenne: "Atlantique Grand-Ouest",
      adresse: "10 boulevard Gaston Doumergue, 44964 Nantes Cedex 9",
      latitude: 47.20811,
      longitude: -1.544726
    },
    {
      ...
      nom: "Siège",
      antenne: "Siège",
      adresse: "120 rue de Bercy, 75012 Paris",
      latitude: 48.841095,
      longitude: 2.3778439
    }
  ];
  ...
  function renderOffices() {
    ...
    for (const o of OFFICES) {
      ...
      const marker = L.marker(ll, {
        icon: L.divIcon({
          className: "pin-dot pin-office",
          html: `
            <div class="pin-dot-inner pin-office-wrap ${isHQ ? "pin-office-hq" : ""}">
              <svg class="pin-office-svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
                <path d="M7 3h10a1 1 0 0 1 1 1v17H6V4a1 1 0 0 1 1-1zm1 4v2h2V7H8zm0 4v2h2v-2H8zm0 4v2h2v-2H8zm6-8v2h2V7h-2zm0 4v2h2v-2h-2zm0 4v2h2v-2h-2zM11 21v-4h2v4h-2z"/>
              </svg>
              ${isHQ ? `<span class="pin-office-badge" title="Siège">★</span>` : ``}
            </div>
          `,
          iconSize: [24, 24],
          iconAnchor: [12, 12]
  ...
  function formatEuro(v){
    ...
    if (!Number.isFinite(n)) return s; // si pas un nombre, renvoie brut
